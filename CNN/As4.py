...
with tf.Session(graph=graph) as session:
  ...
  filename="/Users/banhao/a.png" 
  raw_image_data = mpimg.imread(filename)
  image_data=reformat_image(raw_image_data)
  #print (image_data)
  tf_image_dataset = tf.constant(image_data)
  image_prediction = tf.nn.softmax(model(tf_image_dataset))
  #print(image_prediction.eval())
  a=list(image_prediction.eval())
  print (a[0])
  b=['A','B','C','D','E','F','G','H','I','J']
  i=0
  for i in range(0,10):
    print ("The %s possiblity:%.3f\t\n "% (b[i],a[0][i]))



  # print('Test accuracy: %.1f%%' % accuracy(image_prediction.eval(), test_labels))

  #save_path = saver.save(session, "NOMNIST.ckpt")
